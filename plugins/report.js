...
let handler = async(m, { conn, text }) => {
    ...
    conn.sendMessage('50257681618@s.whatsapp.net', teks1, MessageType.text) // añade tu número aqui, pero no quites el otro. Quita las // del inicio de esta línea
    conn.sendMessage('50230118401@s.whatsapp.net', teks1, MessageType.text)
