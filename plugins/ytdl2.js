...
let _thumb = {}
  ...
  conn.sendMessage(m.chat, `*⏯ ️Descargador By ©Jhusz X-X ⏯️*\n\n*🔥Titulo:* ${title}\n*📂Tamaño del archivo:* ${filesizeF}` , 'conversation', {quoted: m, thumbnail: y, contextInfo:{externalAdReply: {title: 'Everything fine, right?', body: `© ${conn.user.name}`, sourceUrl: 'enviando...', thumbnail: y}}})
