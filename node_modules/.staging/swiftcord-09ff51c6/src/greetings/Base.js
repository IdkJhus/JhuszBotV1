...
module.exports = class Welcome {
    ...
    constructor(){
        ...
        this.memberCount = "0";
        this.backgroundImage = `${__dirname}/../../src/assets/1px.png`;
        this.avatar = `${__dirname}/../../src/assets/default-avatar.png`;
        this.icon = `${__dirname}/../../src/assets/default-avatar.png`;
        this.opacityBorder = "0.4";
        this.colorBorder = "#000000";
        this.colorAvatar = "#23272a"
        ...
        this.colorDiscriminator = "#7289DA";
    ...
    async toAttachment() {
        ...
        ctx.fillText("#"+this.discriminator, tagLength+164, canvas.height - 60);
