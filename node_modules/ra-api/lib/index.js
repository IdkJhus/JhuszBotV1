        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield axios_1.default({
                ...
                const result = {
                    ...
                    author: "I`am ra",
                    result: {
                        thumb: $('div.col-xs-6.col-xs-offset-3.no-padding.lib-item').find('div > div > div:nth-child(1) > img').attr('src'),
                        link_normal: $('#sdlink').attr('href'),
                        link_hd: $('#hdlink').attr('href')
                    }
                };
                resolve(result);
            }).catch(reject);
...
module.exports.facebookDown = facebookDown;
